...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-40 grid h-14 w-14 place-items-center rounded-full shadow-elevated transition hover:scale-108 active:scale-95 md:bottom-6 md:right-6"
    >
      <img src={whatsappIcon} alt="WhatsApp" className="h-14 w-14 rounded-full object-contain drop-shadow-md" />
      <span className="pointer-events-none absolute inset-0 animate-ping rounded-full bg-[#25D366]/30" aria-hidden />
    </a>
  );
}
